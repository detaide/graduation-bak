...
const newBuffer = function (fill, encoding?) {
    return Buffer.from ? Buffer.from(fill, encoding) : Buffer.from(fill, encoding)
};
...
export class Api
{
    ...
    private key : BinaryLike | KeyObject;

    constructor(sdkappid : number, key : BinaryLike | KeyObject)
    {
        console.log(sdkappid, key);
    ...
    _genUserbuf(account, dwAuthID, dwExpTime,
    ...
    */
    ...
    genPrivateMapKey(userid, expire, roomid, privilegeMap) {
    ...
    */
    ...
    genPrivateMapKeyWithStringRoomID(userid, expire, roomstr, privilegeMap) {
